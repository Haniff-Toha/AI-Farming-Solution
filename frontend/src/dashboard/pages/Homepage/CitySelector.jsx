  ...
  return (
    <Card className="mb-8 bg-gradient-to-br from-white to-sky-300 rounded-xl overflow-hidden">
      <CardContent className="p-8 relative">
        ...
        <div className="relative flex flex-col md:flex-row items-center justify-between gap-6 reverse-on-small">
          ...
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-xl sm:text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-sky-600 via-sky-500 to-sky-400">
              Weather Dashboard
            </h1>
          </div>
        </div>
